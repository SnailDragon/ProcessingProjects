...
void draw(){
  ...
  float[] circle2 = OrbitPointSpecial(circle1[0], circle1[1],   150, 20, .5, 0, useTrace);
  float[] circle3 = OrbitPointSpecial(circle2[0], circle2[1],   100, 20, .9, 0, useTrace);
  float[] circle4 = OrbitPointSpecial(circle3[0], circle3[1],   75,  20, .7, 0, useTrace);
  float[] circle5 = OrbitPointSpecial(circle4[0], circle4[1],   50,  20, .8, 0, useTrace);
  float[] circle6 = OrbitPointSpecial(circle5[0], circle5[1],   25,  20, .9, 0, useTrace);
