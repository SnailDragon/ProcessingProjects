...
void draw(){
  ...
  float[] circle2 = OrbitPoint(circle1[0], circle1[1],   150, 20, .5, 0, useTrace);
    float[] circle2a = OrbitPoint(circle1[0], circle1[1],   150, 20, .51, 30, useTrace);
    float[] circle2b = OrbitPoint(circle1[0], circle1[1],   150, 20, .52, 80, useTrace);


  float[] circle3 = OrbitPoint(circle2[0], circle2[1],   100, 20, .9, 0, useTrace);
    float[] circle3a = OrbitPoint(circle2[0], circle2[1],   100, 20, .91, 42, useTrace);
    float[] circle3b = OrbitPoint(circle2[0], circle2[1],   100, 20, .92, 95, useTrace);

  float[] circle4 = OrbitPoint(circle3[0], circle3[1],   75,  20, .7, 0, useTrace);
    float[] circle4a = OrbitPoint(circle3[0], circle3[1],   75,  20, .71, 55, useTrace);
    float[] circle4b = OrbitPoint(circle3[0], circle3[1],   75,  20, .72, 56, useTrace);

  float[] circle5 = OrbitPoint(circle4[0], circle4[1],   50,  20, .8, 0, useTrace);
    float[] circle5a = OrbitPoint(circle4[0], circle4[1],   50,  20, .81, 2, useTrace);
    float[] circle5b = OrbitPoint(circle4[0], circle4[1],   50,  20, .82, 180, useTrace);
  
  float[] circle6 = OrbitPoint(circle5[0], circle5[1],   25,  20, .9, 0, useTrace);
    float[] circle6a = OrbitPoint(circle5[0], circle5[1],   25,  20, .91, 300, useTrace);
    float[] circle6b = OrbitPoint(circle5[0], circle5[1],   25,  20, .92, 87, useTrace);
